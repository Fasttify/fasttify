    ...
    <>
      <AuroraBackground>
        <motion.div
          ...
          className="relative flex flex-col gap-4 items-center justify-center px-4 flex-1 mt-96 sm:mt-10"
        >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="relative z-10 space-y-8">
                  ...
                  <p className="text-lg md:text-xl text-gray-600 leading-relaxed max-w-xl">
                    Fasttify te permite lanzar tu propio ecommerce de dropshipping de manera
                    sencilla. Administra productos, gestiona pagos y haz crecer tu negocio sin
