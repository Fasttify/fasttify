      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-gray-600 leading-relaxed">
            Emprendedores y dueños de tiendas han confiado en Fasttify para
            llevar sus negocios al siguiente nivel. ¡Descubre sus experiencias!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-8">
            ...
            <blockquote className="text-xl text-gray-900 font-medium italic">
              "Fasttify me ha permitido lanzar mi tienda online sin
              complicaciones. La integración con proveedores y pagos es
              increíblemente sencilla. ¡Totalmente recomendado!"
            </blockquote>
            <div>
              <p className="font-medium text-gray-900">María Gómez</p>
              <p className="text-gray-600">
                Dueña de tienda / Usuaria por 6 meses
              </p>
            </div>
          </div>
        </div>
