      ...
      <CardContent className="pt-6 pb-4 px-6">
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <h3 className="text-2xl font-semibold text-gray-800">Plan {subscription.planName}</h3>
            {subscription.pendingPlan === 'free' ? (
              ...
              <p className="text-gray-600 text-sm">Próximo pago: {formattedNextPayment}</p>
            )}
          </div>
                ...
                {plans.map(plan => {
                  ...
                  return (
                    <Card
                      ...
                      aria-disabled={isActive || subscription.pendingPlan === 'free'}
                    >
