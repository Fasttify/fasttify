...
import { MultiStepLoader } from '@/app/(setup)/first-steps/components/MultiStepLoader';
import PersonalInfo from '@/app/(setup)/first-steps/components/PersonalInfo';
import StoreInfo from '@/app/(setup)/first-steps/components/StoreInfo';
import { useFirstStepsSetup } from '@/app/(setup)/first-steps/hooks/useFirstStepsSetup';
