...
import {
  ...
  validateMenuItems,
} from '@/lib/zod-schemas/navigation'
    ...
    return useQuery({
      ...
      queryFn: () => {
        ...
        return performOperation(() =>
          client.models.NavigationMenu.listNavigationMenuByStoreId({ storeId })
        )
      },
  ...
  const useDeleteNavigationMenu = () => {
    return useMutation({
      mutationFn: (id: string) =>
        performOperation(() => client.models.NavigationMenu.delete({ id })),
      onSuccess: (_, id) => {
