  ...
  const tooltipContent = (
    <BlockStack gap="100">
      ...
      <Text variant="bodySm" as="p" tone="subdued">
        El número principal muestra la suma total de visitantes únicos del período. El gráfico muestra visitantes únicos
        por día individual.
      </Text>
    </BlockStack>
  );
                          ...
                          <div
                            ...
                            <BlockStack gap="100">
                              ...
                              <Text variant="bodySm" as="p">
                                Visitantes únicos este día: {formatNumber(currentValue)}
                              </Text>
                              <Text variant="bodySm" as="p" tone="subdued">
