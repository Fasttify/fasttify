...
export function PaymentSettings() {
  const { modalOpen, setModalOpen, selectedGateway, configuredGateways, isLoading, handleOpenModal, handleSubmit } =
    usePaymentSettings();
  ...
  return (
    <Page title="Pagos" fullWidth>
      <Layout>
        ...
        <Layout.Section>
          <PaymentMethodsSection configuredGateways={configuredGateways} onOpenModal={handleOpenModal} />
        </Layout.Section>
        <Layout.Section>
      ...
      <ApiKeyModal open={modalOpen} onOpenChange={setModalOpen} gateway={selectedGateway} onSubmit={handleSubmit} />
    </Page>
  );
}
