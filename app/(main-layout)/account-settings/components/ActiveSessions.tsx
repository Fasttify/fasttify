...
import { Laptop, Smartphone, Tablet, Clock, MapPin, Globe, X, RefreshCw, Shield } from 'lucide-react';
  ...
  return (
    <div className="space-y-8 px-4 pt-4 pb-4 min-h-screen flex flex-col justify-start">
      <div>
        ...
        <p className="text-gray-500 mt-2">Administre sus sesiones activas en todos los dispositivos</p>
      </div>
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          {sessions.length === 0 && (
            <div className="text-center py-8 text-muted-foreground">No se encontraron sesiones activas</div>
          )}
        </CardContent>
      </Card>
