...
import { handleSignUp } from '@/app/(setup-layout)/login/hooks/signUp';
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        {form.formState.errors.root && (
          <div className="p-3 rounded-md bg-red-50 text-red-500 text-sm">{form.formState.errors.root.message}</div>
        )}
        <FormField
            ...
            <FormItem>
              ...
              <FormControl>
                <div className="relative">
                  <Input type={showPassword ? 'text' : 'password'} placeholder="Crea tu contraseña" {...field} />
                  <Button
                    type="button"
                    variant="ghost"
                    size="sm"
