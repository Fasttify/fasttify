import sellingOptionsData from '@/app/(setup)/first-steps/data/selling-options.json';
import { useFormManager } from '@/app/(setup)/first-steps/hooks/useFormManager';
import { useStepManager } from '@/app/(setup)/first-steps/hooks/useStepManager';
import { useStoreCreation } from '@/app/(setup)/first-steps/hooks/useStoreCreation';
import { useTemplateUpload } from '@/app/(setup)/first-steps/hooks/useTemplateUpload';
