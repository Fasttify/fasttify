...
function PierreIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 74 20" width={74} height={20} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
        // fill="var(--color-fg)"
        fill="black"
...
function BMWIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="800px" height="800px" viewBox="0 0 498.503 498.503" xmlns="http://www.w3.org/2000/svg" {...props}>
...
export function LogoCarousell() {
  return (
    <div className="space-y-8 py-12">
      <div className="mx-auto flex w-full max-w-screen-lg flex-col items-center space-y-8">
        <div className="text-center">
          <GradientHeading size="lg" weight="medium" variant="gray">
            Lo mejor ya está aquí
          </GradientHeading>

          <GradientHeading size="lg" weight="medium" variant="black">
            Únete a la revolución Fasttify
          </GradientHeading>

          <p className="mt-4 mb-6 px-4 text-lg text-gray-500 md:px-0">
            Respaldado por las mejores tecnologías, Fasttify lleva tu experiencia digital al siguiente nivel.
          </p>
        </div>
