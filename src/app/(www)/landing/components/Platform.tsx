...
const slides: CompatibilitySlide[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1567581935884-3349723552ca?q=80&w=1974&auto=format&fit=crop',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1530893609608-32a9af3aa95c?q=80&w=1964&auto=format&fit=crop',
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-lg text-gray-600 mb-4">Nuestra plataforma es compatible con todos tus dispositivos:</p>
          ...
          <div className="relative">
            ...
            <NavigationButton direction="prev" onClick={handlePrev} disabled={navigationLocked || activeIndex === 0} />
            <NavigationButton
              direction="next"
              onClick={handleNext}
  ...
  return (
    <div className="flex space-x-2">
      {Array.from({ length: totalSlides }).map((_, index) => (
        <div
          key={index}
          className={`w-2 h-2 rounded-full ${index === activeIndex ? 'bg-white' : 'bg-white bg-opacity-50'}`}
        />
      ))}
    </div>
  );
