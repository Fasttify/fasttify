...
- [Theme Development Guide](./engine/theme-development-guide.mdx) - Guía de desarrollo de temas
- [Theme Studio Customization](./engine/theme-studio-customization.mdx) - **Crear temas personalizables** - Guía completa para crear secciones y bloques personalizables desde el Theme Studio
- [Theme Studio Selection](./engine/theme-studio-selection.mdx) - **Selección bidireccional** - Sistema de selección visual entre sidebar y preview
