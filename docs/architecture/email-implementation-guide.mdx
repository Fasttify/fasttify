...
```typescript
import { EmailNotificationService } from '@liquid-forge/services/notifications/email-notification-service';
...
jest.mock('@liquid-forge/services/notifications/email-notification-service', () => ({
