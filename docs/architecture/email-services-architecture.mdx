...
**Ubicación:** `packages/liquid-forge/services/notifications/`
...
| -------------------------- | ------------------------ | -------------------- | ------------- | ------------------------ |
| `EmailNotificationService` | `packages/liquid-forge/` | Motor de Renderizado | Sistema       | Confirmación automática  |
| `EmailOrderService`        | `packages/liquid-forge/` | Checkout             | Sistema       | Integración con checkout |
| `EmailAdminService`        | `app/store/services/`    | Panel Admin          | Administrador | Notificaciones manuales  |
| `EmailFormattingUtils`     | `packages/liquid-forge/` | Compartido           | Ambos         | Utilidades de formateo   |
...
```
packages/liquid-forge/services/notifications/
...
```typescript
import { EmailNotificationService } from '@/packages/liquid-forge/services/notifications';
