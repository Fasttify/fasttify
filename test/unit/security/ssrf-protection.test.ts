...
describe('SSRF Protection Tests', () => {
  ...
  describe('SecurityConfig Integration', () => {
    test('should reject domains not in allow-list', () => {
      const suspiciousDomains = ['localhost', 'test.local', 'evil.internal', 'metadata.google.internal'];
    ...
    test('should allow valid public domains', () => {
      const validDomains = ['example.com', 'mydomain.org', 'subdomain.example.com', 'test-site.co.uk'];
  ...
  describe('DNSHTTPVerifier SSRF Protection', () => {
    ...
    test('should block malformed domains', async () => {
      const malformedDomains = ['domain..com', 'domain@evil.com', 'domain with spaces.com', '.com', 'com.', ''];
  ...
  describe('DomainValidator SSRF Protection', () => {
    ...
    test('should accept valid public domains', () => {
      const validDomains = ['example.com', 'subdomain.example.com', 'my-domain.co.uk', 'test123.org'];
  ...
  describe('Security Edge Cases', () => {
    ...
    test('should prevent subdomain attacks on allowed domains', () => {
      ...
      const attackDomains = ['localhost.example.com', '127.0.0.1.example.com', 'metadata.google.internal.example.com'];
